...
Tests are in `backend/api_tests/`. The REST API is well-documented (see `backend/API_DOCUMENTATION_ENHANCED.md`).
...
- `ORDER_MIGRATION_COMPLETE.md` - Exemplifies the migration pattern
- `API_PAGINATION_FIX.md` - Explains pagination handling
- `backend/orders/notifications/README.md` - Service architecture example
- `backend/API_DOCUMENTATION_ENHANCED.md` - Complete API reference
