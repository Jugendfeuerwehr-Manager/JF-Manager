...
class RecipientCollector:
    ...
    @staticmethod
    def get_admin_recipients(notification_type: str | None = None) -> list[str]:
        """
        ...
        try:
            ...
            for admin_user in admin_users:
                ...
                if notification_type and not UserPreferencesChecker.check_user_preferences(
    ...
    @staticmethod
    def get_order_recipients(order: Order, notification_type: str | None = None) -> list[str]:
        """
