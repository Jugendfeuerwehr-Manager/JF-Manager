        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "color",
                    models.CharField(
                        default="#6c757d", help_text="Hex-Farbcode für die Anzeige", max_length=7, verbose_name="Farbe"
                    ),
                ),
                ("is_active", models.BooleanField(default=True, verbose_name="Aktiv")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name="Erinnerungen für offene Artikel"),
                ),
                ...
                (
                    ...
                    models.PositiveIntegerField(default=7, verbose_name="Erinnerungs-Intervall (Tage)"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "member",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="members.member", verbose_name="Mitglied"
                    ),
                ),
                (
                    "ordered_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "item",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="orders.orderableitem", verbose_name="Artikel"
                    ),
                ),
                (
                    "order",
                ...
                (
                    "status",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="orders.orderstatus", verbose_name="Status"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("sent", "Gesendet"), ("failed", "Fehlgeschlagen"), ("pending", "Ausstehend")],
                        default="pending",
                        max_length=10,
                        verbose_name="Status",
                    ),
