...
class OrderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Bestellung", {"fields": ("member", "ordered_by", "order_date")}),
        ("Bemerkungen", {"fields": ("notes",), "classes": ("collapse",)}),
    )
...
class OrderItemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Artikel", {"fields": ("order", "item", "size", "quantity")}),
        ("Status", {"fields": ("status", "received_date", "delivered_date")}),
        ("Bemerkungen", {"fields": ("notes",), "classes": ("collapse",)}),
    )
...
class OrderItemStatusHistoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Status-Änderung", {"fields": ("order_item", "from_status", "to_status", "changed_by", "changed_at")}),
        ("Bemerkungen", {"fields": ("notes",), "classes": ("collapse",)}),
    )
...
class NotificationPreferenceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            ...
            {"fields": ("email_daily_summary", "email_weekly_report"), "classes": ("collapse",)},
        ),
        ("Einstellungen", {"fields": ("reminder_frequency_days",), "classes": ("collapse",)}),
    )
...
class NotificationLogAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Benachrichtigung", {"fields": ("notification_type", "recipient_email", "subject", "status")}),
        ("Verknüpfte Objekte", {"fields": ("order", "order_item"), "classes": ("collapse",)}),
        ("Status", {"fields": ("sent_at", "error_message"), "classes": ("collapse",)}),
        ("Zeitstempel", {"fields": ("created_at",), "classes": ("collapse",)}),
    )
...
class EmailTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Template Info", {"fields": ("name", "template_type", "is_active")}),
        ("Email Content", {"fields": ("subject_template", "html_template", "text_template")}),
    )
