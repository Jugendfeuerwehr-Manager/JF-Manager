...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        helmet, created = OrderableItem.objects.get_or_create(
            ...
            defaults={"description": "Feuerwehrhelm nach DIN EN 443", "has_sizes": False, "is_active": True},
        )
        if created:
        ...
        self.stdout.write(self.style.SUCCESS("Beispiel-Ausrüstungsgegenstände wurden erfolgreich erstellt!"))
