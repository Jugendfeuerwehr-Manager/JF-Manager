...
class OrderFilter(filters.FilterSet):
    ...
    def filter_member_name(self, queryset, name, value):
        ...
        return queryset.filter(Q(member__name__icontains=value) | Q(member__lastname__icontains=value))
...
class OrderItemFilter(filters.FilterSet):
    ...
    class Meta:
        model = OrderItem
        fields = ["order", "member", "status", "status_code", "item", "item_category", "date_from", "date_to"]
...
class OrderableItemFilter(filters.FilterSet):
    ...
    def filter_search(self, queryset, name, value):
        ...
        return queryset.filter(
            Q(name__icontains=value) | Q(category__icontains=value) | Q(description__icontains=value)
        )
