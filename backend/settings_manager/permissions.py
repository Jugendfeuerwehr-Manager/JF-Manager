...
class SettingsPermissionMixin(PermissionRequiredMixin):
    ...
    def handle_no_permission(self):
        ...
        raise PermissionDenied(
            "Sie haben keine Berechtigung, diese Einstellungen zu verwalten. Wenden Sie sich an Ihren Administrator."
        )
...
class CategoryPermissionMixin:
    ...
    def get_category_permissions(self, category_code):
        ...
        """
        return {"view": f"view_{category_code}_settings", "change": f"change_{category_code}_settings"}
