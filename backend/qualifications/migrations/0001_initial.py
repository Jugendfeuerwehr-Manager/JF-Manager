    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="z.B. 'Grundlehrgang', 'Sprechfunk'", max_length=200, verbose_name="Name"
                    ),
                ),
                (
                    "expires",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="z.B. 'Jugendsprecher', 'Kleiderwart'", max_length=200, verbose_name="Name"
                    ),
                ),
                ("description", models.TextField(blank=True, verbose_name="Beschreibung")),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_acquired",
                    models.DateField(help_text="Datum des Erwerbs der Qualifikation", verbose_name="Erworben am"),
                ),
                (
                    "date_expires",
                    models.DateField(
                        blank=True, help_text="Ablaufdatum (falls erforderlich)", null=True, verbose_name="Läuft ab am"
                    ),
                ),
                (
                    "issued_by",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="qualifications.qualificationtype",
                        verbose_name="Qualifikationstyp",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="qualifications.specialtasktype",
