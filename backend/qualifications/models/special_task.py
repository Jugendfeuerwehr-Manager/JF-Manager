...
class SpecialTaskType(models.Model):
    ...
    name = models.CharField(max_length=200, verbose_name="Name", help_text="z.B. 'Jugendsprecher', 'Kleiderwart'")
...
class SpecialTask(models.Model):
    ...
    task = models.ForeignKey(SpecialTaskType, on_delete=models.CASCADE, verbose_name="Aufgabe")
    ...
    start_date = models.DateField(verbose_name="Startdatum", help_text="Datum des Beginns der Aufgabe")
    end_date = models.DateField(
        null=True, blank=True, verbose_name="Enddatum", help_text="Datum des Endes der Aufgabe (leer = noch aktiv)"
    )
    note = models.TextField(blank=True, verbose_name="Notiz")

    # Generic relation to attachments
    attachments = GenericRelation("members.Attachment", related_query_name="specialtask")
