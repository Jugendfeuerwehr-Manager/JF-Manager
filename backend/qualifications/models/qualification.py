...
class QualificationType(models.Model):
    ...
    name = models.CharField(max_length=200, verbose_name="Name", help_text="z.B. 'Grundlehrgang', 'Sprechfunk'")
    expires = models.BooleanField(
        default=False, verbose_name="Läuft ab", help_text="Wenn aktiviert, ist ein Ablaufdatum erforderlich"
    )
...
class Qualification(models.Model):
    ...
    type = models.ForeignKey(QualificationType, on_delete=models.CASCADE, verbose_name="Qualifikationstyp")
    ...
    date_acquired = models.DateField(verbose_name="Erworben am", help_text="Datum des Erwerbs der Qualifikation")
    date_expires = models.DateField(
        null=True, blank=True, verbose_name="Läuft ab am", help_text="Ablaufdatum (falls erforderlich)"
    )
    ...
    attachments = GenericRelation("members.Attachment", related_query_name="qualification")
