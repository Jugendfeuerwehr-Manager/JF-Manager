...
class Item(models.Model):
    ...
    base_unit = models.CharField(max_length=50, default="Stück", verbose_name="Grundeinheit")
    ...
    rented_by = models.ForeignKey(
        Member, blank=True, on_delete=models.SET_NULL, null=True, verbose_name="Ausgeliehen von"
    )
