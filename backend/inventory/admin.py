...
class ItemVariantAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Variante", {"fields": ("parent_item", "sku", "variant_attributes")}),
        ("Statistiken", {"fields": ("total_stock",), "classes": ("collapse",)}),
    )
...
class TransactionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Transaktion", {"fields": ("transaction_type", "item", "quantity", "date")}),
        ("Bewegung", {"fields": ("source", "target")}),
        ("Details", {"fields": ("user", "note")}),
    )
