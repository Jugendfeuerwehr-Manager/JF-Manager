...
class LibraryBlockListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = LibraryBlock
        fields = [
            'id', 'export_uuid', 'title', 'description',
            'default_duration_minutes', 'category', 'category_name',
            'category_color', 'tags', 'color', 'is_public', 'created_at',
...
class LibraryBlockDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = LibraryBlock
        fields = [
            'id', 'export_uuid', 'title', 'description', 'content',
            'default_duration_minutes', 'category', 'category_id',
            'tags', 'tag_ids', 'color', 'nextcloud_folder_url',
            'is_public', 'source_instance_url', 'created_by',
...
class LibraryBlockExportSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = LibraryBlock
        fields = [
            'export_uuid', 'title', 'description', 'content',
            'default_duration_minutes', 'category', 'tags',
