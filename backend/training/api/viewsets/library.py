...
class LibraryBlockViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return LibraryBlock.objects.select_related(
            'category', 'created_by'
    ...
    def import_blocks(self, request):
        ...
        for item in blocks_data:
            ...
            if item.get('category'):
                category, _ = LibraryBlockCategory.objects.get_or_create(
                    name=item['category']
                )
            ...
            block, created = LibraryBlock.objects.update_or_create(
                export_uuid=export_uuid, defaults=defaults
            )
