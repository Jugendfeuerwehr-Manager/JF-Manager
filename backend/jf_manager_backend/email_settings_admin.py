...
class EmailSettingsForm(forms.Form):
    ...
    email_host = forms.CharField(
        label="SMTP Server", required=False, help_text="Hostname oder IP-Adresse des SMTP-Servers (z.B. smtp.gmail.com)"
    )
    email_port = forms.IntegerField(
        label="SMTP Port", required=False, help_text="Port des SMTP-Servers (z.B. 587 für TLS, 465 für SSL)"
    )
    email_host_user = forms.CharField(
        label="SMTP Benutzername", required=False, help_text="Benutzername für die Authentifizierung beim SMTP-Server"
    )
    ...
    email_use_tls = forms.BooleanField(
        label="TLS verwenden", required=False, help_text="TLS-Verschlüsselung für die E-Mail-Verbindung verwenden"
    )
    ...
    default_from_email = forms.EmailField(
        label="Absender E-Mail", required=False, help_text="E-Mail-Adresse, die als Absender verwendet wird"
    )
